...
const Aside = () => {
    ...
    return (
        <ul className="menu bg-base-200 text-base-content min-h-full w-72 p-4">
            ...
            {location.pathname === "/dashboard" && <li className='mt-2'><button onClick={showAdd}><PlusCircleIcon className='h-6 w-6' />Add Product</button></li>}
            <li className='mb-4 mt-2'><Link to={"/dashboard"}><ArchiveBoxIcon className='h-6 w-6' />My Products</Link></li>
